/*
  ...
  * Modifiers's website: http://jordanell.com
*/
...
var Countries = {
  ...
  fillCountries: function(selectorId) {
    var select = document.getElementById(selectorId);

    if (select === null) {
      console.error("Countries.js: Selector id \'" + selectorId + "\' cannot be found");
      return;
    }
  ...
  fillStates: function(selectorId, countryName) {
    ...
    select.length         = 0;  // Fixed by Julian Woods
  ...
  create: function(countrySelectorId, stateSelectorId) {
    var country = document.getElementById(countrySelectorId);
    var state   = document.getElementById(stateSelectorId);

    if (country === null || state === null) {
      console.error("Countries.js: could not create new countries configuration.");
      return
    }
    ...
    country.addEventListener('change', function() {
      ...
      cb.fillStates(stateSelectorId, value)
    }, false)
  }
}